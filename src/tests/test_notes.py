...
def test_create_note_invalid_json(test_app):
    ...
    )  # Title and description too short
    assert response.status_code == 422
...
# Paramterize test to run several scenarios at once
@pytest.mark.parametrize(
    ...
    [
        ...
        [1, {"title": "1", "description": "bar"}, 422],  # Test length restraints
